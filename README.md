# Бэкенд для регистрации и авторизации пользователей в проекте "Личная фотогалерея"
...
`.env` — файл для хранения переменных окружения (в репозитории отсутствует, необходимо создать локально).
